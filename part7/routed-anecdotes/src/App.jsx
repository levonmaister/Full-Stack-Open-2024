...
const Notification = ({notification, setNotification}) => {
  ...
  return(
    <div>a new anecdote {mynotifi} created!</div>
  )
...
const App = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/anecdotes" element={<AnecdoteList anecdotes={anecdotes} notification={notification} setNotification={setNotification}/>}/>
